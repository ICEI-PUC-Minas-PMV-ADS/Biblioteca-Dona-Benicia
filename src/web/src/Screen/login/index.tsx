    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 rounded-full">
        ...
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-texto">
          ...
          <form className="space-y-6" action="#" method="POST">
            <div>
              <label htmlFor="email" className="block text-sm font-medium leading-6 text-texto">
              Email              </label>
              <div className="mt-2">
                <input
                  id="email"
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md bg-texto px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Enviar
              </button>
            </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Não tem uma conta?{' '}
            <a href="/Person" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
            Cadastre-se
            </a>
          </p>
        </div>
